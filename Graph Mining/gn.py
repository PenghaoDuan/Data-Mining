# -*- coding: utf-8 -*-
"""
Created on Sat Nov 17 19:54:35 2018
...
inverse_node_dict = {}
adjacency_matrix = []
# This list used for stroing the pairs 
pairs = []
...
if __name__ == '__main__':   
    ...
    for i in range(len(node_dict)):        
        ...
        for i_index,nodeObject in result.items():
    ...
    for pair in pairs:
        ...
        output.append("{0} {1}".format(pair,edge_score_matrix[i_index][j_index]))
